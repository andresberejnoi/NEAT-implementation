...
class Genome():
    ...
    def mutate(self, mRate=0.01):
        ...
        if r()<mRate:           #there should actually be different mutation rates for the 3 different kinds of mutations possible
            pass
...
class WeightGene():
    ...
    def reproduce(self, gene2):
        ...
        receiveNode_inherit = self.receivingNode if r() < 0.5 else gene2.receivingNode
